    ...
    <>
      ...
      <div className='flex h-screen w-full flex-row items-center justify-center' style={{ backgroundImage: `url('${bg.src}')`, backgroundRepeat: "no-repeat", backgroundSize: "100%" }}>
        <div className='flex flex-row items-center justify-center' style={{ transform: `translate3d(${offset}px, 0, 0)` }}>
          ...
          <div className='weekly-plan-card  hover:transform-hover overflow-scroll z-0 bg-[#FCFCFC] shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] w-[20vw] h-[85vh]' ref={weeklyPlanCardRef}>
          ...
          <div className='overflow-scroll z-0 bg-[#FCFCFC] shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] flex w-[45vw] h-[90vh] flex-row justify-around' >
